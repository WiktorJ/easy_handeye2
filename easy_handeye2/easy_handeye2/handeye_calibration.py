...
class HandeyeCalibrationParametersProvider:
    def __init__(self, node: Node):
        ...
        self.node.declare_parameter('name', '', descriptor=ParameterDescriptor(
